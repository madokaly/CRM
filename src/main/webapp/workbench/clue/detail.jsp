		...
		$.ajax({
			...
			success : function (data) {
				...
				$.each(data,function (i,n) {
					...
					str += "<td>"+n.endDate+"</td>";
					str += "<td>"+n.owner+"</td>";
					str += "<td><a href='javascript:void(0);' onclick='unbund(\""+n.id+"\")'  style='text-decoration: none;'><span class='glyphicon glyphicon-remove'></span>解除关联</a></td>";
					str += "</tr>";
				})
...
<body>
	...
	<div style="position: relative; left: 40px; top: -30px;">
		<div class="page-header">
			<h3>${clue.fullname}${clue.appellation} <small>${c.company}</small></h3>
		</div>
